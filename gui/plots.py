...
def open_variable_plot():
    ...
    Button(popup, text="Visa graf", command=lambda: generate_variable_plot(x_var.get(), y_var.get(), group_var.get()), bg="#004728", fg="#fff").pack(pady=20)

def generate_variable_plot(x_axis: str, y_axis: str, group_by: str):
